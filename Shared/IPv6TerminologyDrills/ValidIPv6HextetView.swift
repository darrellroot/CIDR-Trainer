...
struct ValidIPv6HextetView: View, DrillHelper {
    ...
    func wrongAnswer() {
        ...
        thisGame?.wrong()
        lastResult = """
            Incorrect: :\(given.value): is \(given.valid ? "valid" : "invalid")
            because \(given.type.explanation)
            """
    ...
    func correctAnswer() {
        ...
        lastResult = """
            Correct:
            \(given.value) is \(given.valid ? "valid" : "invalid")
            because \(given.type.explanation)
            """
        displayCheck = true
        withAnimation {
    ...
    var body: some View {
        if displayPurchaseView {
            ...
            ZStack {
                VStack {
                    List {
                        ...
                        Section("Next Task") {
                            Text("Is :\(given.value): a valid IPv6 hextet?")
                        }
            ...
            .navigationTitle("Valid IPv6 Hextets")
