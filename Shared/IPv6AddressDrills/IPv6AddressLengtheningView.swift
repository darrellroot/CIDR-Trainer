//
//  IPv6AddressLengtheningView.swift
//  CIDR Trainer
//
...
struct IPv6AddressLengtheningView: View, DrillHelper {
    static let staticFetchRequest = Games.ipv6AddressLengthening.fetchRequest
    ...
    var body: some View {
        if displayPurchaseView {
            ...
            .navigationTitle("IPv6 Address Lengthening")
...
struct IPv6AddressLengtheningView_Previews: PreviewProvider {
    static var previews: some View {
        IPv6AddressLengtheningView()
    }
}
